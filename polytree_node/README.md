...
If you need a refresher on algorithms and data structures, refer to the reading! Accessing this on GitHub? Use this link.
Learning Goals
...
In addition to 
(1) re-assigning the parent attribute of the child and 
(2) adding it to the new parent's array of children, we should also 
(3) remove the child from the old parent's list of children (if the old parent isn't nil). Modify your #parent= method to do this.
